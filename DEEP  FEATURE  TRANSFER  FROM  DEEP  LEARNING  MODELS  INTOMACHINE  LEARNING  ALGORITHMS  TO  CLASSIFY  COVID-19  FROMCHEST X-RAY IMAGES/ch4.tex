...
Pr(c_{i} | \textbf{x}) = \frac{Pr(\textbf{x}|c_{i}) Pr(c_{i})}{Pr(\textbf{x})}, 
\ee
...
In this thesis, to solve the LDA functions, we use the solvers presented by \href{https://scikit-learn.org/stable/whats_new/v0.23.html}{\texttt{scikit-learn}}
package \cite{scikit-learn} in \href{https://www.python.org/downloads/release/python-376/}{\texttt{Python}} programming language. Further information about estimators provided by \href{https://scikit-learn.org/stable/whats_new/v0.23.html}{\texttt{scikit-learn}} package can be found at \cite{scikit-learn_lda-solvers}.
